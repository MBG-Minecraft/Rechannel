...
class StartRecording : ListenerAdapter(), Command {
    ...
    override fun getCommandData(): SlashCommandData =
        Commands.slash("record", "Starts listening and recording all voice in the channel")
            ...
            .addOption(OptionType.NUMBER, "seconds", "The amount of seconds to release each segment of audio by. Default is 2 minutes", false)
    ...
    override fun execute(event: SlashCommandInteractionEvent) {
        ...
        val seconds = event.getOption("seconds")?.asLong ?: TimeUnit.MINUTES.toMillis(2)
        if (seconds < 0) {
